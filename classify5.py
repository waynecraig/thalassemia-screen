...
data_name = "g-0819-1"
data_desc = "MCV>80 Female"
result_path = f"data/result/SVM/{data_name}"
...
classifier = SVC(kernel="rbf", C=1.0, random_state=1, probability=True)
...
plt.savefig(f"{result_path}/shap", dpi=300)
plt.close()
